...
@Service
@Slf4j
public class RecommendMapperServiceImpl extends ServiceImpl<RecommendMapper, Recommend> implements RecommendMapperService {
    ...
    public IPage<Recommend> queryPage(Integer page, Integer limit) {
        return baseMapper.selectPage(new Query<Recommend>(page, limit).getPage(),
