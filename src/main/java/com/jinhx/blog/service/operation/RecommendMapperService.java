 ...
 * @since 2019-02-22
 */
public interface RecommendMapperService extends IService<Recommend> {
     ...
     * @return 推荐列表
     */
    IPage<Recommend> queryPage(Integer page, Integer limit);
     ...
     * @return 推荐列表
     */
    List<Recommend> listRecommends(Integer module);
